  ...
  <div class="flowBox">
    <h6><span>商品列表1 </span></h6>
      ...
      <?php if ($this->_var['show_goods_attribute'] == 1): ?>
              ...
              <?php endif; ?>
              <th bgcolor="#ffffff"><?php echo $this->_var['lang']['shop_prices']; ?>aa</th>
...
?>
              ...
              <?php endif; ?>
              <td align="right" bgcolor="#ffffff"><?php echo $this->_var['goods']['goods_price']; ?>aa</td>
          ...
          <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            <tr>
              <td bgcolor="#ffffff">
              <?php if ($this->_var['discount'] > 0): ?><?php echo $this->_var['your_discount']; ?>a<br /><?php endif; ?>
              <?php echo $this->_var['shopping_money']; ?>b<?php if ($this->_var['show_marketprice']): ?>，<?php echo $this->_var['market_price_desc']; ?>c<?php endif; ?>
              </td>
              <td align="right" bgcolor="#ffffff">
...
?>
  ...
  function fittings_to_flow(goodsId,parentId)
  {
    ...
    // Ajax.call('flow.php?step=add_to_cart', 'goods=' + goods.toJSONString(), fittings_to_flow_response, 'POST', 'JSON');
       Ajax.call('flow.php?step=add_to_cart', 'goods=' + obj2str(goods), fittings_to_flow_response, 'POST', 'JSON');	
  }
...
?>
        ...
        <div class="flowBox">
        <h6><span>商品列表1111</span><?php if ($this->_var['allow_edit_cart']): ?><a href="flow.php" class="f6"><?php echo $this->_var['lang']['modify']; ?></a><?php endif; ?></h6>
        <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            <tr>
              <th bgcolor="#ffffff"><?php echo $this->_var['lang']['goods_name']; ?></th>
              <th bgcolor="#ffffff"><?php echo $this->_var['lang']['goods_attr']; ?></th>
